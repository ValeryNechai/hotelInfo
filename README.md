...
### Используемые технологии: Java 21, Spring Boot, Hibernate, Spring Data JPA, H2, Maven, Liquibase.

## ✨ Особенности
- 🔄 Автоматические миграции БД через Liquibase
- 📚 Swagger документация API
- 🧪 Tестирование контроллера
- 🔄 Готовность к переключению на другие СУБД
...
### Документация API доступна после запуска приложения по ссылке: http://localhost:8092/swagger-ui/index.html
...
2. **Address, Contacts, ArrivalTime** — детализированные вложенные объекты 
